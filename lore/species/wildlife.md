...
The count used to be eleven. Then the census caught up with the rest of the map, and the honest number is now in the forties. The tiers below sort them the way wanderers actually think about them: what runs, what warns, and what hunts.
...
- **Deer** and **Stag**: skittish crepuscular browsers. Bolting is their whole strategy, and "a deer that bolted too slow" is the canonical description of venison. The stag is the same animal with more neck and more pride.
- **Zebra**: savanna grazers, immune to heat. Long the only tier-1 animal that thrives where the scorch kills; it now has company.
- **Antilope** and **Oryx**: the savanna's sprinters. The antilope's plan is speed. The oryx's plan is speed plus horns, which makes it the one skittish animal you should not corner.
- **Pig**: plains rooter, rounder cousin of the boar and far less opinionated. Eats anything, bothers nobody, feeds everybody.
- **Ostrich**: a bird that decided flight was for cowards. Skittish, faster than you, and equipped with a kick nobody talks about twice.
- **Turtle** and **Tortoise**: the swamp and beach's slowest residents. Passive, armored, and living proof that not everything in Corpus wants you dead.
- **Camel**: desert walker, heat-proof and patient. Wanderers crossing the dunes have been known to follow one out of sheer respect for its navigation.
- **Ram**, **Llama**, **Alpaca**, and **Yak**: the rocky flats' woolly delegation. The alpaca and llama are placid, the yak mostly is, and the ram will meet a rude wanderer at full speed.
- **The horses**: brown, work, and Arabian strains, plus the **Donkey**. Feral herds that drift the plains and forest edges. Skittish to a fault; nobody has stayed on one long enough to change that. The donkey is slower, stubborner, and kicks like it holds a grudge from a previous rung.
- **Monkey** and **Chimp**: jungle canopy dwellers. Monkeys travel in loud troops and flee anything larger than fruit. Chimps are the exception in the tier: passive until pushed, and much stronger than their size suggests.
...
- **Mammoth**: the snowy plains' walking monument. Cold-proof, patient, and enormous. Old hands treat a mammoth sighting like weather: you do not fight it, you route around it.
