...
import fluentEmojiCat from '@iconify-icons/fluent-emoji/cat';
...
import fluentEmojiDog from '@iconify-icons/fluent-emoji/dog';
import fluentEmojiDogFace from '@iconify-icons/fluent-emoji/dog-face';
...
import fluentEmojiGlowingStar from '@iconify-icons/fluent-emoji/glowing-star';
...
import fluentEmojiPenguin from '@iconify-icons/fluent-emoji/penguin';
...
import fluentEmojiSparkles from '@iconify-icons/fluent-emoji/sparkles';
...
import mdiSwapHorizontalBold from '@iconify-icons/mdi/swap-horizontal-bold';
...
const bundledIconifyIcons: Record<string, IconifyIcon> = {
  ...
  'fluent-emoji:cat': fluentEmojiCat,
  'fluent-emoji:cut-of-meat': fluentEmojiCutOfMeat,
  'fluent-emoji:deer': fluentEmojiDeer,
  'fluent-emoji:dog': fluentEmojiDog,
  'fluent-emoji:dog-face': fluentEmojiDogFace,
  ...
  'fluent-emoji:glowing-star': fluentEmojiGlowingStar,
  ...
  'fluent-emoji:penguin': fluentEmojiPenguin,
  ...
  'fluent-emoji:sparkles': fluentEmojiSparkles,
