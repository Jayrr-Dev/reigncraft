...
export const DEFINING_PLAZA_LAPIDARY_ORE_PORTRAIT_CARD_ZOOM = 1.05;

/** Zoom applied on the larger detail page hero. */
export const DEFINING_PLAZA_LAPIDARY_ORE_PORTRAIT_DETAIL_ZOOM = 1.45;

/** CSS filter that flattens the sprite into a locked-entry silhouette. */
export const DEFINING_PLAZA_LAPIDARY_ORE_PORTRAIT_SILHOUETTE_FILTER =
