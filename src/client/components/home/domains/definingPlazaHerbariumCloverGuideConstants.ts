  ...
  [
    ...
    },
    {
      ...
      propertiesSummaryFull:
        'Held: Lucky charm. Halves disease risk, skews damage taken safer and damage dealt stronger, and improves rare finds until the leaf fades (1 in-game day while held).',
    },
  ] as const;
