...
const RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_ABOVE_CLASS_NAME = `${RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_SHELL_CLASS_NAME} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelAnchoredCenter} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelAbove}`;

const RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_ABOVE_END_CLASS_NAME = `${RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_SHELL_CLASS_NAME} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelAnchoredEnd} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelAbove}`;

const RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_BELOW_CLASS_NAME = `${RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_SHELL_CLASS_NAME} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelAnchoredCenter} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelBelow}`;

const RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_BELOW_END_CLASS_NAME = `${RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_SHELL_CLASS_NAME} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelAnchoredEnd} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.explanationPopover.panelBelow}`;
...
export type RenderingWorldPlazaGameplayHudExplanationPopoverProps = {
  ...
  /** Horizontal anchor for above/below placement. Default center; use end for top-right stacks. */
  anchor?: 'center' | 'end';
};
...
export function RenderingWorldPlazaGameplayHudExplanationPopover({
  ...
  const panelClassName =
    placement === 'inline'
      ...
      : placement === 'below'
        ? anchor === 'end'
          ? RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_BELOW_END_CLASS_NAME
          : RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_BELOW_CLASS_NAME
        : anchor === 'end'
          ? RENDERING_WORLD_PLAZA_GAMEPLAY_HUD_EXPLANATION_POPOVER_PANEL_ABOVE_END_CLASS_NAME
