 ...
 *
 * @module components/world/chest/domains/computingWorldPlazaProceduralChestSeedUnitFromTileIndex
 */

/**
 * Returns a stable unit in [0, 1) from tile coords + salt.
 */
export function computingWorldPlazaProceduralChestSeedUnitFromTileIndex(
  tileX: number,
  tileY: number,
  salt: number
): number {
