...
/** Inset frame around the companion portrait glyph. */
export const DEFINING_WILDLIFE_PET_MODAL_PORTRAIT_FRAME_CLASS_NAME =
  `${STYLING_WORLD_PLAZA_PROFILE_PANEL_PORTRAIT_FRAME_CLASS_NAME} flex items-center justify-center` as const;
...
/** Advanced stat trio grid (shared attribute grid chrome). */
