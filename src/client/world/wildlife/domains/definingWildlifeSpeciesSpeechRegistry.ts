...
> = {
  ...
  'cow-brown': buildingWildlifeSpeciesSpeechLines({
    neutral: ['Moo', 'Mooo...'],
    friendly: ['Mooo~', 'Mmmmmm'],
    eating: ['Mooo~', 'mmmMMMmm', 'mnch mnch', 'crrnch'],
    flee: ['MoooOOO!', 'Moooo!'],
    chase: ['MoooOOO!', 'Snort!', 'Stomp!'],
    attack: ['MoooOOO!', 'Snort!', 'Stomp!'],
    warn: ['Snort!', 'Grunting!', 'Stomp!', 'MoooOOO!'],
    wake: ['Moo-brown?!', 'Low moo?!'],
  }),
  ...
  pinguin: buildingWildlifeSpeciesSpeechLines({
    neutral: ['Honk', 'Wark', 'Hnk'],
    friendly: ['Honk honk', 'Wark~', 'Hnk hnk'],
    eating: ['glrp', 'mnch', 'pk pk'],
    flee: ['HONK!', 'WARK!'],
    chase: ['HONK!', 'HNK!'],
    attack: ['HONK!', 'SNAP!', 'WARK!'],
    warn: ['Honk!', 'Wark!', 'Hnk!'],
    wake: ['Honk?!', 'Wark?!'],
  }),
  ...
  husky: buildingWildlifeSpeciesSpeechLines({
    neutral: ['Awoo', 'Bark', 'Huff'],
    friendly: ['Awoo!', 'Bark bark!', 'Woof~'],
    eating: ['Chomp', 'mnch mnch', 'Nom'],
    flee: ['Yipe!', 'Whine!'],
    chase: ['Bark!', 'Awoo!'],
    attack: ['GRRR!', 'Snap!', 'Bark!'],
    warn: ['Grr...', 'Awoo!', 'Bark!'],
    wake: ['Awoo?!', 'Husky-bark?!'],
  }),
  'golden-retriever': buildingWildlifeSpeciesSpeechLines({
    neutral: ['Bark', 'Woof', 'Arf'],
    friendly: ['Bark!', 'Woof woof!', 'Arf arf~', 'Ruff!'],
    eating: ['Chomp', 'mnch mnch', 'Nom'],
    flee: ['Yipe!', 'Whine!'],
    chase: ['Bark!', 'Woof!'],
    attack: ['GRRR!', 'Bark!', 'Snap!'],
  ...
  'cat-orange': buildingWildlifeSpeciesSpeechLines({
    neutral: ['Meow', 'Mrrp', 'Mrow', 'Prr'],
  ...
  grizzly: buildingWildlifeSpeciesSpeechLines({
    neutral: ['Huff', 'Grunt', 'Rrr'],
    friendly: ['Hrmmm~', 'Ahhh~'],
    eating: ['mnch mnch', 'smkk smkk', 'glrp~'],
    flee: ['GRRR!', 'RAAWR!'],
    chase: ['GRRRR!', 'RAAWR!', 'Snort!'],
    attack: ['RAAWR!', 'CHOMP!', 'KRRRKK!', 'GRRRRR!'],
    warn: ['Grunting!', 'Snort!', 'Stomp!', 'GRRRRR!', 'RAAWR!'],
    eatingAggressive: ['KRRRKK', 'GRRRROWL', 'gnaw gnaw'],
    wake: ['Grizz-huff?!', 'RAAW?!'],
  }),
  ...
  fairy: buildingWildlifeSpeciesSpeechLines({
    neutral: ['Ting', 'Fizz'],
    friendly: ['Ting~', 'Fizz fizz'],
    eating: ['sparkle', 'fizz'],
    flee: ['Ting!', 'Fizz!'],
    wake: ['Ting?!', 'Fairy-fizz?!'],
  }),
};
