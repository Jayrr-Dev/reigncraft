...
> = {
  ...
  zebra: {
    ...
    vitals: {
      ...
      attackPower: 5,
      defense: 2,
      walkSpeedGridPerSecond: 2.6,
      runSpeedGridPerSecond: 6,
    },
  },
  boar: {
    speciesId: 'boar',
  ...
  'grey-wolf': {
    ...
    vitals: {
      ...
      attackPower: 14,
      defense: 3,
      walkSpeedGridPerSecond: 2.8,
      runSpeedGridPerSecond: 6.5,
    },
  },
  'brown-bear': {
