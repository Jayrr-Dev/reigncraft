 ...
 *
 * @module components/world/wildlife/domains/checkingWildlifePlayerApproachingStalker
 */
...
export type CheckingWildlifePlayerApproachingStalkerParams = {
...
/** True when the player is actively closing distance on a nearby stalker. */
export function checkingWildlifePlayerApproachingStalker({
  playerPosition,
...
}: CheckingWildlifePlayerApproachingStalkerParams): boolean {
