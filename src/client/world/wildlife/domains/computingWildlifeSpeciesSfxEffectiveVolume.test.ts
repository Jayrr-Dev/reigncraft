import { computingWildlifeSpeciesSfxDistanceAttenuation } from '@/components/world/wildlife/domains/computingWildlifeSpeciesSfxEffectiveVolume';
import {
  ...
  it('extends predator howls beyond farm ambient range', () => {
    ...
    expect(
      computingWildlifeSpeciesSfxDistanceAttenuation(
        listenerPoint,
        {
          x: DEFINING_WILDLIFE_SPECIES_SFX_PREDATOR_MAX_AUDIBLE_DISTANCE_GRID,
          y: 0,
        },
        'howl',
        'predator'
