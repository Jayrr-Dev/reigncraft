...
export const DEFINING_WILDLIFE_MEAT_CATALOG: readonly DefiningWildlifeMeatCatalogEntry[] =
  [
    ...
    {
      speciesId: 'sunhead',
      rawItemTypeId: 'world-plaza-raw-sunhead-meat',
      cookedItemTypeId: 'world-plaza-cooked-sunhead-meat',
      rawDisplayName: 'Raw Sunhead Meat',
      cookedDisplayName: 'Cooked Sunhead Meat',
      rawHungerRestoreRatio: 0.36,
      cookedHungerRestoreRatio: 0.68,
      lootQuantity: 2,
      cookDurationMs: 9_000,
