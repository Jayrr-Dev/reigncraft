...
> = {
  plains: {
    ...
    [DEFINING_WORLD_PLAZA_WATER_KIND_RIVER]:
      definingWorldPlazaBiomeStillWaterPalette(0x2f84a8, 0x2b8cb3, 0.55),
    [DEFINING_WORLD_PLAZA_WATER_KIND_STREAM]:
      definingWorldPlazaBiomeStillWaterPalette(0x52b0cf, 0x2b8cb3, 0.55),
    [DEFINING_WORLD_PLAZA_WATER_KIND_POND]:
      definingWorldPlazaBiomeStillWaterPalette(0x357a78, 0x4a8f8a, 0.52),
  },
  forest: {
    [DEFINING_WORLD_PLAZA_WATER_KIND_LAKE]:
      definingWorldPlazaBiomeLakeWaterPalette(
    ...
    [DEFINING_WORLD_PLAZA_WATER_KIND_RIVER]:
      definingWorldPlazaBiomeStillWaterPalette(0x2a7a98, 0x267f9e, 0.54),
    [DEFINING_WORLD_PLAZA_WATER_KIND_STREAM]:
      definingWorldPlazaBiomeStillWaterPalette(0x4aa8c4, 0x267f9e, 0.54),
    [DEFINING_WORLD_PLAZA_WATER_KIND_POND]:
      definingWorldPlazaBiomeStillWaterPalette(0x2f6e62, 0x3f8578, 0.5),
  },
  flower_forest: {
    [DEFINING_WORLD_PLAZA_WATER_KIND_LAKE]:
      definingWorldPlazaBiomeLakeWaterPalette(
    ...
    [DEFINING_WORLD_PLAZA_WATER_KIND_RIVER]:
      definingWorldPlazaBiomeStillWaterPalette(0x3188a6, 0x2d8eae, 0.55),
    [DEFINING_WORLD_PLAZA_WATER_KIND_STREAM]:
      definingWorldPlazaBiomeStillWaterPalette(0x55b4d0, 0x2d8eae, 0.55),
    [DEFINING_WORLD_PLAZA_WATER_KIND_POND]:
  ...
  swamp: {
    [DEFINING_WORLD_PLAZA_WATER_KIND_SWAMP_POND]:
      definingWorldPlazaBiomeStillWaterPalette(0x35472f, 0x3c4a30, 0.66),
    [DEFINING_WORLD_PLAZA_WATER_KIND_RIVER]:
      definingWorldPlazaBiomeStillWaterPalette(0x3a5240, 0x425848, 0.58),
    [DEFINING_WORLD_PLAZA_WATER_KIND_STREAM]:
      definingWorldPlazaBiomeStillWaterPalette(0x4a6450, 0x425848, 0.58),
  },
  savanna: {
    [DEFINING_WORLD_PLAZA_WATER_KIND_RIVER]:
      definingWorldPlazaBiomeStillWaterPalette(0x4a8a9a, 0x4e92a2, 0.52),
    [DEFINING_WORLD_PLAZA_WATER_KIND_STREAM]:
      definingWorldPlazaBiomeStillWaterPalette(0x68a8b8, 0x4e92a2, 0.52),
    [DEFINING_WORLD_PLAZA_WATER_KIND_POND]:
      definingWorldPlazaBiomeStillWaterPalette(0x6a7a48, 0x7a8a58, 0.48),
  },
  badlands: {},
  beach: {
    [DEFINING_WORLD_PLAZA_WATER_KIND_LAKE]:
    ...
    [DEFINING_WORLD_PLAZA_WATER_KIND_RIVER]:
      definingWorldPlazaBiomeStillWaterPalette(0x3a9cb8, 0x42a8c4, 0.56),
    [DEFINING_WORLD_PLAZA_WATER_KIND_STREAM]:
      definingWorldPlazaBiomeStillWaterPalette(0x5ec0d8, 0x42a8c4, 0.56),
    [DEFINING_WORLD_PLAZA_WATER_KIND_POND]:
      definingWorldPlazaBiomeStillWaterPalette(0x4a9898, 0x5aa8a8, 0.54),
  },
  ocean: {
    [DEFINING_WORLD_PLAZA_WATER_KIND_LAKE]:
      definingWorldPlazaBiomeLakeWaterPalette(
