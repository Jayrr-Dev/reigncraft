...
export const DEFINING_WORLD_PLAZA_ACTION_BAR_ANCHOR_CLASS_NAME =
  "pointer-events-none absolute inset-x-0 top-2 z-40 flex justify-center px-3" as const;

/** Scale applied to the plaza action bar (1 = legacy size). */
export const DEFINING_WORLD_PLAZA_ACTION_BAR_SCALE = 1 as const;
...
export const DEFINING_WORLD_PLAZA_ACTION_BAR_DIVIDER_HEIGHT_BASE_PX = 20 as const;

/** Base horizontal divider margin in px (Tailwind mx-1). */
export const DEFINING_WORLD_PLAZA_ACTION_BAR_DIVIDER_MARGIN_X_BASE_PX = 4 as const;

/** Base friends notification badge diameter in px. */
export const DEFINING_WORLD_PLAZA_ACTION_BAR_NOTIFICATION_BADGE_BASE_PX = 12 as const;

/** Base friends notification badge label size in px. */
export const DEFINING_WORLD_PLAZA_ACTION_BAR_NOTIFICATION_BADGE_TEXT_BASE_PX = 8 as const;
