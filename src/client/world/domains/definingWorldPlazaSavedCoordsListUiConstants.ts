...
export const DEFINING_WORLD_PLAZA_SAVED_COORDS_LIST_BADGE_CLASS_NAME =
  "h-5 min-w-0 flex-[1_1_calc((100%-0.5rem)/2)] max-w-full shrink-0 justify-center truncate rounded-sm border border-[#f4d35e]/35 bg-[#f4d35e]/12 px-0.5 text-[9px] font-medium tabular-nums text-[#f4d35e]" as const;
