...
export {
  WORLD_PLAZA_GIPHY_API_KEY_ENV as DEFINING_WORLD_PLAZA_GIPHY_API_KEY_ENV,
  WORLD_PLAZA_GIPHY_SEARCH_DEFAULT_LIMIT as DEFINING_WORLD_PLAZA_GIPHY_SEARCH_DEFAULT_LIMIT,
  WORLD_PLAZA_GIPHY_CONTENT_RATING as DEFINING_WORLD_PLAZA_GIPHY_CONTENT_RATING,
  WORLD_PLAZA_GIPHY_API_BASE_URL as DEFINING_WORLD_PLAZA_GIPHY_API_BASE_URL,
