...
export const LABELING_WORLD_PLAZA_PERFORMANCE_DIAGNOSTICS_FLAG_PRESET_COPY_FINDINGS =
  'Copy findings' as const;

export const LABELING_WORLD_PLAZA_PERFORMANCE_DIAGNOSTICS_FLAG_PRESET_COPY_FINDINGS_SUCCESS =
  'FLAGS compare copied' as const;

export const LABELING_WORLD_PLAZA_PERFORMANCE_DIAGNOSTICS_FLAG_PRESET_COPY_FINDINGS_FAILURE =
  'Could not copy FLAGS compare' as const;
