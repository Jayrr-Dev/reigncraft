...
export function resolvingWorldPlazaGameplayHudOverlayLayerClassName(): string {
  return `${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_STYLE.cssShell.gameplayHudOverlay} ${DEFINING_WORLD_PLAZA_GAMEPLAY_HUD_LAYOUT.overlayLayerClassName} ${DEFINING_WORLD_PLAZA_GAME_AREA_SELECT_NONE_CLASS_NAME}`;
}
