...
export const DEFINING_WORLD_PLAZA_VIEWPORT_HUD_REFERENCE_WIDTH_PX =
  1280 as const;

/** Reference viewport height (px) where HUD controls render at authored base size. */
export const DEFINING_WORLD_PLAZA_VIEWPORT_HUD_REFERENCE_HEIGHT_PX =
  720 as const;
...
export const DEFINING_WORLD_PLAZA_VIEWPORT_HUD_MAX_SCALE = 1.3 as const;
