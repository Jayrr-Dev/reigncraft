...
export const DEFINING_WORLD_PLAZA_PERFORMANCE_DIAGNOSTICS_OVERLAY_CLASS_NAME =
  "pointer-events-auto fixed left-4 top-20 z-[9999] max-h-[calc(100vh-5rem)] max-w-[min(92vw,24rem)] overflow-y-auto rounded-md border border-amber-300/40 bg-black/90 p-2.5 font-mono text-[10px] leading-relaxed text-amber-50 shadow-lg backdrop-blur-sm" as const;
