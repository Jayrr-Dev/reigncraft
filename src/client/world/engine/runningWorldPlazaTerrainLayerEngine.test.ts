...
describe('creatingWorldPlazaTerrainLayerEngine', () => {
  ...
  it('marks an incremental layer incomplete from cross-layer invalidation', () => {
    ...
    const dependencySnapshot = {
      ...
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.LONG_GRASS_TEXTURES_READY]:
        '1',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.SHRUB_TEXTURES_READY]: '1',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.CHEST_TEXTURES_READY]: '1',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.BLACKSMITH_UTILITY_TEXTURES_READY]: '1',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.BEAR_TRAP_TEXTURES_READY]: '1',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.CALTROP_TEXTURES_READY]: '1',
    };
  ...
  it('waits for long-grass textures before completing the grass layer', () => {
    ...
    const loadingDependencySnapshot = {
      ...
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.THAW_VISUAL]: '0|',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.SUN_BUCKET]: '0',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.DAY_NUMBER]: '1',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.PLAYER_TILE]: '4,4',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.ISLAND_MODE_REVISION]: '0',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.PROCEDURAL_TREES_AND_ROCKS_REVISION]:
        '0',
      ...
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.LONG_GRASS_TEXTURES_READY]:
        '0',
      [DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.SHRUB_TEXTURES_READY]: '0',
