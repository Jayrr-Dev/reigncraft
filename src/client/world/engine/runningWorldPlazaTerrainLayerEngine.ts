...
> = {
  ...
  [REGISTERING_WORLD_PLAZA_TEXTURE_ASSET_ID.CHEST_SPRITES]:
    DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.CHEST_TEXTURES_READY,
  [REGISTERING_WORLD_PLAZA_TEXTURE_ASSET_ID.BLACKSMITH_UTILITY_SPRITES]:
    DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.BLACKSMITH_UTILITY_TEXTURES_READY,
  [REGISTERING_WORLD_PLAZA_TEXTURE_ASSET_ID.BEAR_TRAP_SPRITES]:
    DEFINING_WORLD_PLAZA_TERRAIN_DEPENDENCY_KEY.BEAR_TRAP_TEXTURES_READY,
  [REGISTERING_WORLD_PLAZA_TEXTURE_ASSET_ID.CALTROP_SPRITES]:
...
export const RUNNING_WORLD_PLAZA_TERRAIN_LAYER_ID = {
  ...
  FROSTSINK_DECORATIONS: 'frostsink-decorations',
  FLOOR_CHUNKS: 'floor-chunks',
  FLOWER_DECORATIONS: 'flower-decorations',
  LONG_GRASS_DECORATIONS: 'long-grass-decorations',
  SHRUB_DECORATIONS: 'shrub-decorations',
  MUSHROOM_DECORATIONS: 'mushroom-decorations',
