...
const RENDERING_WORLD_PLAZA_CLAIM_MODE_TILE_POPOVER_CLAIM_LABEL = "Claim" as const;
...
export function RenderingWorldPlazaClaimModeTilePopover({
  ...
  return (
    <div
      ref={wrapperRef}
      className={RENDERING_WORLD_PLAZA_CLAIM_MODE_TILE_POPOVER_WRAPPER_CLASS_NAME}
      style={{
        transform: RENDERING_WORLD_PLAZA_CLAIM_MODE_TILE_POPOVER_HIDDEN_TRANSFORM,
      }}
    >
      <div
        ref={shellRef}
