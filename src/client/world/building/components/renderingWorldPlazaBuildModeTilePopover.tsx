...
const RENDERING_WORLD_PLAZA_BUILD_MODE_TILE_POPOVER_PLACE_LABEL =
  'Place' as const;

/** Remove block action label. */
const RENDERING_WORLD_PLAZA_BUILD_MODE_TILE_POPOVER_REMOVE_LABEL =
  'Remove' as const;
...
export function RenderingWorldPlazaBuildModeTilePopover({
  ...
  return (
    <div
      ref={wrapperRef}
      className={
        RENDERING_WORLD_PLAZA_BUILD_MODE_TILE_POPOVER_WRAPPER_CLASS_NAME
      }
      style={{
        transform:
          RENDERING_WORLD_PLAZA_BUILD_MODE_TILE_POPOVER_HIDDEN_TRANSFORM,
      }}
    >
      <div
        ref={shellRef}
