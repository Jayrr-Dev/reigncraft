...
/** Discard build draft dialog title typography classes. */
export const DEFINING_WORLD_BUILDING_DISCARD_DRAFT_DIALOG_TITLE_CLASS_NAME =
  DEFINING_WORLD_PLAZA_CONFIRM_DIALOG_STYLE.title;

/** Discard build draft dialog message typography classes. */
export const DEFINING_WORLD_BUILDING_DISCARD_DRAFT_DIALOG_MESSAGE_CLASS_NAME =
  DEFINING_WORLD_PLAZA_CONFIRM_DIALOG_STYLE.message;

/** Discard build draft dialog body layout classes. */
export const DEFINING_WORLD_BUILDING_DISCARD_DRAFT_DIALOG_BODY_CLASS_NAME =
  DEFINING_WORLD_PLAZA_CONFIRM_DIALOG_STYLE.body;

/** Discard build draft dialog action row layout classes. */
export const DEFINING_WORLD_BUILDING_DISCARD_DRAFT_DIALOG_ACTIONS_CLASS_NAME =
...
export { DEFINING_WORLD_DEPTH_BUILD_PLACEMENT_PREVIEW_Z_INDEX as DEFINING_WORLD_BUILDING_PLACEMENT_PREVIEW_Z_INDEX } from '@/components/world/depth';

/** Sort build tile overlays just beneath avatars at the same isometric depth. */
export { DEFINING_WORLD_DEPTH_BUILD_TILE_OVERLAY_Z_INDEX_OFFSET as DEFINING_WORLD_BUILDING_TILE_OVERLAY_Z_INDEX_OFFSET } from '@/components/world/depth';
