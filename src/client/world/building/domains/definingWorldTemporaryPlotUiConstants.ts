...
export const DEFINING_WORLD_TEMPORARY_PLOT_LIST_BADGE_CLASS_NAME =
  "h-5 min-w-0 flex-[1_1_calc((100%-0.5rem)/2)] max-w-full shrink-0 justify-center truncate rounded-sm border border-blue-700/45 bg-blue-600/20 px-0.5 text-[9px] font-medium tabular-nums text-blue-100" as const;
