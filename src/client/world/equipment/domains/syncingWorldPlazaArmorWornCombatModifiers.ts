/**
 * Rebuilds armor-set combat damage-roll modifiers from the current loadout.
 *
...
/**
 * Clears prior armor-set combat modifiers, then applies Chaos + Bessemer + Glass Veil.
 */
