...
import { checkingWorldPlazaActiveOreSmeltingHeatAtTileIndex } from '@/components/world/crafting/domains/managingWorldPlazaActiveOreSmeltingHeatTilesStore';
...
export function checkingWorldPlazaTileHasAssignableEnvironmentalTemperatureSourceAtTileIndex({
  ...
  if (checkingWorldPlazaActiveOreSmeltingHeatAtTileIndex(tileX, tileY)) {
    return true;
  }
