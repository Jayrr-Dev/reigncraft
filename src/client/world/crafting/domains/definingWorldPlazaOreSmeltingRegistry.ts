...
export const DEFINING_WORLD_PLAZA_ORE_SMELTING_RECIPE_REGISTRY = [
  ...
  {
    inputItemTypeId: DEFINING_WORLD_PLAZA_INVENTORY_ITEM_TYPE_WET_CLAY_BOWL,
    outputItemTypeId: DEFINING_WORLD_PLAZA_INVENTORY_ITEM_TYPE_EMPTY_CLAY_BOWL,
    outputDisplayName: 'Empty Clay Bowl',
    durationMs: 5_500,
    fuelCostMultiplier: 1,
    allowedStationBlockDefinitionIds: [
      DEFINING_WORLD_BUILDING_BLOCK_ID_UTILITY_CLAY_KILN,
  ...
  {
    inputItemTypeId: DEFINING_WORLD_PLAZA_INVENTORY_ITEM_TYPE_WET_CLAY_CROCK,
    outputItemTypeId: DEFINING_WORLD_PLAZA_INVENTORY_ITEM_TYPE_EMPTY_CLAY_CROCK,
    outputDisplayName: 'Empty Clay Crock',
    durationMs: 7_500,
    fuelCostMultiplier: 2,
    allowedStationBlockDefinitionIds: [
      DEFINING_WORLD_BUILDING_BLOCK_ID_UTILITY_CLAY_KILN,
