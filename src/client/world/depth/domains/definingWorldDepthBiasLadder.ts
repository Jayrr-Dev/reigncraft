...
export const DEFINING_WORLD_DEPTH_AVATAR_GROUND_SHADOW_ENTITY_DEPTH_BIAS = 1 as const;

/** Tree ground shadow entity depth bias (matches avatar shadow). */
export const DEFINING_WORLD_DEPTH_TREE_GROUND_SHADOW_ENTITY_DEPTH_BIAS = 1 as const;

/** Lifts placed block columns above clearable terrain on the same tile. */
export const DEFINING_WORLD_DEPTH_PLACED_BLOCK_COLUMN_TERRAIN_CLEARANCE_DEPTH_BIAS = 1 as const;

/** Renders tree trunks above procedural terrain columns at the same foot. */
export const DEFINING_WORLD_DEPTH_TREE_TRUNK_TERRAIN_COLUMN_DEPTH_BIAS = 2 as const;

/**
 * Z-index gap subtracted from a foreground column when clamping the avatar body
 * behind it.
 */
export const DEFINING_WORLD_DEPTH_AVATAR_BODY_FRONT_OCCLUDER_STANDING_Z_INDEX_MARGIN = 3 as const;
...
export const DEFINING_WORLD_DEPTH_TERRAIN_ELEVATION_COLUMN_RENDER_DEPTH_BIAS = 0 as const;
...
export const DEFINING_WORLD_DEPTH_PLAYER_NIGHT_LIGHT_FLOOR_WARM_GLOW_DEPTH_BIAS = 1 as const;

/** Click-arrow effect offset above entity base sort key. */
export const DEFINING_WORLD_DEPTH_CLICK_ARROW_EFFECT_Z_INDEX_OFFSET = 1 as const;

/** Inventory drop tile outline offset above entity base sort key. */
export const DEFINING_WORLD_DEPTH_INVENTORY_DROP_TILE_OUTLINE_Z_INDEX_OFFSET = 4 as const;
...
export const DEFINING_WORLD_DEPTH_AVATAR_GROUND_SHADOW_BODY_SYNC_Z_INDEX_OFFSET = -1 as const;

/** Tile radius scanned around the avatar foot for body and shadow sort rules. */
export const DEFINING_WORLD_DEPTH_AVATAR_BODY_SORT_FOOTPRINT_TILE_RADIUS = 2 as const;

/** Tile radius for avatar ground shadow footprint scans. */
export const DEFINING_WORLD_DEPTH_AVATAR_GROUND_SHADOW_FOOTPRINT_TILE_RADIUS = 2 as const;

/** Tile radius for placed-block shadow occlusion (tighter than terrain). */
export const DEFINING_WORLD_DEPTH_AVATAR_GROUND_SHADOW_PLACED_BLOCK_OCCLUDER_TILE_RADIUS = 1 as const;

/** Tile radius for tree ground shadow footprint scans. */
export const DEFINING_WORLD_DEPTH_TREE_GROUND_SHADOW_FOOTPRINT_TILE_RADIUS = 3 as const;
