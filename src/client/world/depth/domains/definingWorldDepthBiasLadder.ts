...
/** Mushrooms sit just under flowers, above floor stone pebbles. */
export const DEFINING_WORLD_DEPTH_MUSHROOM_DECORATION_LAYER_Z_INDEX =
  DEFINING_WORLD_DEPTH_WATER_SURFACE_LAYER_Z_INDEX - 3.5;
