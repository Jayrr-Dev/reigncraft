...
/**
 * Ceramics ware inventory sprite sheet (4×3 @ 32px):
 * wet cup, wet teapot, empty teapot, wet bottle,
 * empty bottle, watered bottle, wet bowl, empty bowl,
 * porridge, wet crock, empty crock, smoke-oil crock.
 *
...
export const DEFINING_WORLD_PLAZA_INVENTORY_CERAMICS_SPRITE_SHEET_COLUMN_COUNT = 4;
export const DEFINING_WORLD_PLAZA_INVENTORY_CERAMICS_SPRITE_SHEET_ROW_COUNT = 3;
