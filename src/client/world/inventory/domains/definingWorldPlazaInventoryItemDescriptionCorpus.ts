...
import { DEFINING_WORLD_PLAZA_FORAGE_ITEM_DESCRIPTION_ENTRIES } from '@/components/world/inventory/domains/definingWorldPlazaForageItemDescriptionCorpus';
...
const DEFINING_WORLD_PLAZA_INVENTORY_ITEM_DESCRIPTION_STATIC_ENTRIES: readonly DefiningWorldPlazaInventoryItemDescriptionEntry[] =
  [
    ...
    },
    {
      ...
      description:
        'Dried leaves from berry shrubs. Brew in a clay teapot at a campfire, or chew them raw when the run starts to wear you down.',
    },
    {
...
> {
  ...
  for (const entry of DEFINING_WORLD_PLAZA_FORAGE_ITEM_DESCRIPTION_ENTRIES) {
    corpus[entry.typeId] = entry.description;
  }
