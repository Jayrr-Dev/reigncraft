...
export const DEFINING_WORLD_PLAZA_GROUND_ITEM_PICKUP_RADIUS_TILES = 1.5 as const;
...
export const DEFINING_WORLD_PLAZA_GROUND_ITEM_PICKUP_HINT_LIFT_BASE_PX = 10 as const;
