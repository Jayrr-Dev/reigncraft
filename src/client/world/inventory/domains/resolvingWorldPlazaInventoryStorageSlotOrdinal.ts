...
import { DEFINING_WORLD_PLAZA_INVENTORY_STORAGE_SLOT_START } from '@/components/world/inventory/domains/definingWorldPlazaInventoryConstants';
...
export function resolvingWorldPlazaInventoryStorageSlotOrdinal(
  ...
  if (
    ...
    slotIndex >= DEFINING_WORLD_PLAZA_INVENTORY_STORAGE_EXPANSION_MAX_CAPACITY
  ) {
    return null;
  }
