...
import { DEFINING_WORLD_PLAZA_INVENTORY_HOTBAR_SCALE } from '@/components/world/inventory/domains/definingWorldPlazaInventoryRoughSketchConstants';
...
/** Cooked-meat tone for filled hunger icons. */
export const DEFINING_WORLD_PLAZA_HUNGER_INDICATOR_FOOD_FILL_COLOR = '#d97b4a';
