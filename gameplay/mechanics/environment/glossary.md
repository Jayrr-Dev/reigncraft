...
| **Ice block standing tile**  | **−22°C** on `utility:ice-block`; freezes nearby surface water.                                                         |
| **Frozen water tile**        | Walkable ice: climate-frozen (noise ≤ **0.3**) or cold-source frozen. Night climate ice also samples **−14°C** ambient. |
...
| **Water phase temperature**  | Warmest/coldest assignable source °C in the neighbor ring; drives freeze/thaw.                                          |
...
| **Melting point**           | **0°C**. Assignable heat at or above thaws; assignable cold below freezes.        |
