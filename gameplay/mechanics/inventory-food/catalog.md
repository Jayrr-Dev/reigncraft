...
| Item | `itemTypeId` | Restore ratio | Restore % | Disease / buff | Edit file |
| ---- | ------------ | ------------- | --------- | -------------- | --------- |
| Berries | `world-plaza-berries` | 0.15 | 15% | None | `definingWorldPlazaInventoryItemTypes.ts` |
| Apple | `world-plaza-apple` | 0.25 | 25% | None | `definingWorldPlazaInventoryItemTypes.ts` |
...
| Hotbar consume flow | `renderingWorldPlazaPixiScene.tsx` |
