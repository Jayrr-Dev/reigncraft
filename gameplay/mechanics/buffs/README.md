...
| [catalog.md](./catalog.md) | All **96** registry buffs with effect, source, and edit file |
...
| Registry | File |
| -------- | ---- |
| Buff catalog (**96 entries**) | `src/client/world/health/domains/definingWorldPlazaEntityBuffRegistry.ts` |
