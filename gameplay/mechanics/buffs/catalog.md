...
| -- | -------- | -------- | -------------- | -------------------- | ------------ |
| `disease-nausea-slow-debuff` | debuff | timed 60s | −30% speed | salmonellosis, liver-fluke, toxoplasmosis, … | `definingWorldPlazaEntityBuffRegistry.ts` + disease grants |
...
| `disease-stamina-sick-debuff` | debuff | timed 120s | Stamina drain ×1.5 | liver-fluke, parasites | same |
