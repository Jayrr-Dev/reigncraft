...
| ------ | -------- | ----- |
| Cooked meat eat | `well-fed-*` | `resolvingWorldPlazaInventoryFoodEatEffects.ts` |
| Disease grant | `disease-*`, confusion/sleep/stun from grants | `applyingWorldPlazaEntityDiseaseStageGrant.ts` |
