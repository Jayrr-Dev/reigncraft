...
| Skin id            | Display name     | HP       | Atk EV  | Def    | Atk spd  | Walk    | Run     | Jump scale | Size     | Hunger × | Immunities | Skills                   |
| ------------------ | ---------------- | -------- | ------- | ------ | -------- | ------- | ------- | ---------- | -------- | -------- | ---------- | ------------------------ |
| `girl-sample`      | Girl             | **1000** | **300** | **5**  | **1**    | **2**   | **3**   | **1**      | **1**    | **1**    | —          | minor-heal, swift-stride |
| `husky`            | Husky            | **950**  | **300** | **6**  | **1**    | **2**   | **3.2** | **1**      | **1.05** | **1.15** | cold       | minor-heal, swift-stride |
...
| **Attack power (EV) / defense** | **300** / **10**                             |
| **Attack speed**                | **0.85**                                     |
