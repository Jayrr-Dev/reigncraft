...
| **Biome region cell**   | 128×128 tile chunk used for biome assignment (finer than realms). Scales with `DEFINING_WORLD_PLAZA_BIOME_WORLD_LINEAR_SCALE` (**4**). |
...
| **Explored biome kind** | Codex progress by biome _kind_ (separate store).                                                                                       |
