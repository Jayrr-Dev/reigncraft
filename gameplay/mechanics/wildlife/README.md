...
| ---------------- | ----------------------------------------------------------------------- |
| **Version**      | 1.1.0                                                                   |
| **Last updated** | 2026-07-10 (wildlife footsteps: 1/3 avatar volume, disjoint clip pools) |
...
| Species SFX profiles and concurrency                    | `definingWildlifeSpeciesSfxProfileRegistry.ts` + `definingWildlifeFarmAnimalSfxConstants.ts` + `definingWildlifeVocalSfxConcurrency.ts`                                                                               |
| Species SFX pool gain / replay / max duration           | `definingWildlifeSpeciesSfxPoolVolumeMultipliers.ts`, `resolvingWildlifeSpeciesSfxPoolMinReplayIntervalMs.ts`, `resolvingWildlifeSpeciesSfxPoolMaxPlaybackDurationS.ts`                                              |
| Species SFX simulation bridge                           | `notifyingWildlifeSpeciesSfxFromSimulation.ts`, `applyingWildlifeSpeechTickWithSpeciesSfx.ts`; playback `usingWildlifeSpeciesSfx.ts` + shared `managingWorldPlazaStarAudio.ts`                                        |
