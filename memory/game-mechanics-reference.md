...
**Lapidary codex:** Guide → Lapidary; ore veins unlock on approach / mine; inventory **Study** + mine floors raise Study; same tiers **1 / 5 / 15 / 25**. Ore bag Info dialog unlocks field notes, work notes, habitat, and vein numbers by Lapidary Study (`resolvingWorldPlazaInventoryOreDetailReveal.ts`).
