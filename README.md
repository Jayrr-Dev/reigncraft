...
Six starter skins: the Girl (human playable animal) plus Husky, Golden Retriever, Grizzly, Penguin, and Cat Orange. Skins differ in HP, defense, speed, jump, hunger drain, and immunities (Husky and Penguin resist cold; Grizzly resists bleed). Skills are `minor-heal`, `swift-stride`, and `heat-ward`, assigned per skin. Study a wildlife corpse to unlock that animal as a playable skin; the long-term goal is every species in the world.
